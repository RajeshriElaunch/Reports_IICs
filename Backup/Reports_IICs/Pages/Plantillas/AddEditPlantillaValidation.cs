...
{
    public class AddEditPlantillaValidation : IDataErrorInfo
    {
            ...
            get
            {
                ...
                if (columnName == "Codigo")
                {
                    if (string.IsNullOrEmpty(Codigo))
                    {
                        ...
                        result = Resources.Resource.IntroduceCodigo_Message;
                    ...
                    else
                    {
                        ...
                        {
                            result = Resources.Resource.CodigoYaExiste_Message;
                        }
