namespace Reports_IICs.Reports.Renta_Variable
{
    ...
    /// <summary>
    /// Summary description for ReportRentabilidadVariable_GRUPO2_SUB.
    /// </summary>
    public partial class ReportRentabilidadVariable_GRUPO2_SUB : Telerik.Reporting.Report
    {
        ...
        public ReportRentabilidadVariable_GRUPO2_SUB()
        {
            //
        ...
        private void ReportRentabilidadVariable_GRUPO2_SUB_ItemDataBound(object sender, EventArgs e)
        {
