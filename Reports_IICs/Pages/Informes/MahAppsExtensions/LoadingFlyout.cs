...
namespace Reports_IICs.Pages.Informes.MahAppsExtensions
{
    public class LoadingFlyout : Flyout
    {
        ...
        internal void ApplyAnimation(Position position)
        {
            ...
            var hideFrame = (SplineDoubleKeyFrame)GetTemplateChild("hideFrame");
            var hideFrameY = (SplineDoubleKeyFrame)GetTemplateChild("hideFrameY");
            var showFrame = (SplineDoubleKeyFrame)GetTemplateChild("showFrame");
            var showFrameY = (SplineDoubleKeyFrame)GetTemplateChild("showFrameY");
