namespace Reports_IICs.Reports.Rentabilidad_Cartera
{
    ...
    /// </summary>
    public partial class ReportRentabilidadCarteraV1 : Telerik.Reporting.Report
    {
        private string _codigoIC;
        public ReportRentabilidadCarteraV1()
        {
            //
        ...
        public ReportRentabilidadCarteraV1(string isin, string codigoic, DateTime fecha)
        {
            InitializeComponent();            
