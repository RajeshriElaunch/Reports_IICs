namespace Reports_IICs.Reports.Renta_Variable
{
    ...
    /// <summary>
    /// Summary description for ReportRentabilidadVariable_GRUPO3_SUB.
    /// </summary>
    public partial class ReportRentabilidadVariable_GRUPO3_SUB : Telerik.Reporting.Report
    {
        ...
        public ReportRentabilidadVariable_GRUPO3_SUB()
        {
            //
        ...
        private void ReportRentabilidadVariable_GRUPO3_SUB_ItemDataBound(object sender, EventArgs e)
        {
