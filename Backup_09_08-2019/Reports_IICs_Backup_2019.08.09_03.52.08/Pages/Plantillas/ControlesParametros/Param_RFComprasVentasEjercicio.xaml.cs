...
{
    /// <summary>
    /// Lógica de interacción para Param_RFComprasVentasEjercicio.xaml
    /// </summary>
    public partial class Param_RFComprasVentasEjercicio : UserControl
    {
        private Parametros_RFComprasVentasEjercicio parametros;
        ...
        public Param_RFComprasVentasEjercicio()
        {
            InitializeComponent();
        }

        public Param_RFComprasVentasEjercicio(Parametros_RFComprasVentasEjercicio param)
        {
            InitializeComponent();
            parametros = param;
            Loaded += OnLoaded;
        ...
        private void AddElement_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            parametros.FechaAnterior = this.DpFechaAnterior.SelectedDate.Value;
        ...
        private void OnLoaded(object sender, RoutedEventArgs routedEventArgs)
        {
            ...
            if (parametros != null && parametros.FechaAnterior != null) DpFechaAnterior.Text = parametros.FechaAnterior.ToString();
