...
{
    /// <summary>
    /// Lógica de interacción para Param_RVComprasRealizadasEjercicio.xaml
    /// </summary>
    public partial class Param_RVComprasRealizadasEjercicio : UserControl
    {
        public Parametros_RVComprasRealizadasEjercicio parametros;
        ...
        public Param_RVComprasRealizadasEjercicio()
        {
            InitializeComponent();
        }

        public Param_RVComprasRealizadasEjercicio(Parametros_RVComprasRealizadasEjercicio param)
        {
            InitializeComponent();
            parametros = param;
            Loaded += OnLoaded;
